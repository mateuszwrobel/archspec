...
The hidden `capability` command (diagnostic surface, not a stable API) prints the driver capability table that `verify` and `doctor` read: [commands/capability/index.md](commands/capability/index.md).
